...
exports.author_list = async function(req, res, next) {
    ...
    try {
        ...
        res.render('author_list', { title: 'Author List', author_list:list_authors_slice, currentPage: vPage, pageCount, itemCount, itemsOnPage:vLimit, arrow:arrow, sortOrder:order, searchString:vSearchStr });
    ...
    */
    ...
    .exec(function (err, list_authors) {
        ...
        Author.countDocuments(vSearchQuery, function(err, authorCount) {
            ...
            res.render('BACKUP_author_list', { title: 'Backup Author List', author_list: list_authors, currentPage: vPage, pageCount, itemCount, itemsOnPage:vLimit, arrow:arrow, sortOrder:order, searchString:vSearchStr });
        })
      });
}
...
exports.author_create_get =  function(req, res, next) {
    ...
    res.render('author_form', { title: 'Create Author',  createDupe:createDupe, sendDuplicateAlert:sendDuplicateAlert, mode:mode});
}
...
exports.author_create_post = function(req, res, next) {
    ...
    if (errors.isEmpty()) {
        ...
        console.log("createDupe = " + createDupe + "; query = " + JSON.stringify(query) )
            ...
            if (found_author) {
                if (queryType=="id") {
                    ...
                    if (createDupe == 0) {
                        ...
                        author._id = found_author._id
                        res.render('author_form', { title: 'Create Author', author: author, errors: errors.array(), sendDuplicateAlert:1, mode:"c"});
                    } else {
                ...
                console.log("The author was not found!!  query = " + JSON.stringify(query))
                author.save(function (err) {
                    if (err) { return next(err); }
                    // Author saved. Redirect to Author detail page.
                    res.redirect(author.url);
        ...
        createDupe=0
        sendDuplicateAlert=0
        res.render('author_form', { title: 'Create Author', author: author,  createDupe:createDupe, sendDuplicateAlert:sendDuplicateAlert,  mode:"c",   errors: errors.array()});
        //return
...
exports.author_update_get = function(req, res, next) {
    ...
    .exec(function (err, author) {
        ...
        res.render('author_form', { title: 'Edit Author', author: author, sendDuplicateAlert:0, mode:"u" });
      });
...
exports.author_update_post = function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        res.render('author_form', { title: 'Edit Author', author: author, mode:"u", errors: errors.array()});
    } else {
